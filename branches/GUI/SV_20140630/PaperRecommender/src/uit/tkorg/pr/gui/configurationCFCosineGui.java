 ...
 * @author Zoe
 */
public class configurationCFCosineGui extends javax.swing.JDialog {

    /**
     * Creates new form configurationCFCosineGui
     */
    public configurationCFCosineGui(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                configurationCFCosineGui dialog = new configurationCFCosineGui(new javax.swing.JFrame(), true);
