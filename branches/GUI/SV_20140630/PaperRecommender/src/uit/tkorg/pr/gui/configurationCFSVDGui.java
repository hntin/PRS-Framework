 ...
 * @author Zoe
 */
public class configurationCFSVDGui extends javax.swing.JDialog {

    /**
     * Creates new form configurationCFCosineGui
     */
    public configurationCFSVDGui(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                configurationCFSVDGui dialog = new configurationCFSVDGui(new javax.swing.JFrame(), true);
